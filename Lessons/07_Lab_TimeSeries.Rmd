...
Plot_rain <- ggplot(BRA_complete, aes(x = Date, y = Rainfall)) +
  geom_point() +
  geom_smooth(method = "lm")

print(Plot_rain)

Plot_temp <- ggplot(BRA_complete, aes(x = Date, y = Temperature_C)) +
  geom_point() +
  geom_smooth(method = "lm")
...
Rainfall_trendplot <- ggplot(Rainfall_Components) +
  geom_line(aes(x = Date, y = Observed)) +
  geom_line(aes(x = Date, y = trend, color = "red")) +
  labs( color = "Trend")

print(Rainfall_trendplot)
...
Temp_trendplot <- ggplot(Temp_Components) +
  geom_line(aes(x = Date, y = Observed)) +
  geom_line(aes(x = Date, y = trend, color = "red")) +
  labs( color = "Trend")

print(Temp_trendplot)
```
...
rain_trend_test
rain_trend_test <- smk.test(Rainfall_ts)

summary(rain_trend_test)

temp_trend_test
temp_trend_test <- smk.test(Temp_ts)

summary(temp_trend_test)
