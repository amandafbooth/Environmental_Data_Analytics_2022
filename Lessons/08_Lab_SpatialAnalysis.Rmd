...
huc8_uppernuese_sf <- st_read('./Data/Spatial/NCHUC8.shp') %>%
...
Plot2 <- ggplot() +
  ...
  geom_sf(data = huc8_uppernuese_sf, fill = 'purple') 
...
huc8_wind <- merge(x = huc8_sf, y = wind_raw, by.x = "HUC_8", by.y = "HUC_8")
