...
matrix1[4, ] # just gives row
matrix1[ , 3] # just gives column
matrix1[c(12, 14)] #
matrix1[c(12:14)] #
matrix1[2:4, 1:3] #
...
low <- c(27, 27, 15, 25, 27, 35, 47, 53, 30, 22)

high <- c(45, 50, 34, 43, 51, 54, 59, 66, 57, 42)
```
...
```{r}
temp_data <- data.frame(high, low, high_c, low_c)

names(temp_data) <- c("Temp high (F)","Temp low (F)","Temp high (C)", "Temp low (C)")
...
sd(temp_data$`Temp high (F)`)
sd(temp_data$`Temp low (F)`)
```
